...
fig_env1.savefig(
    fname=str(cfg.OUT_DIR/f"sim_04_f1_env_LoS.{cfg.EXT}"),
    format=cfg.EXT,
)
fig_env2.savefig(
    fname=str(cfg.OUT_DIR/f"sim_04_f1_env_image.{cfg.EXT}"),
    format=cfg.EXT,
)
fig2.savefig(
    fname=str(cfg.OUT_DIR/f"sim_04_f1_env_powers.{cfg.EXT}"),
    format=cfg.EXT,
)
fig3.savefig(
    fname=str(cfg.OUT_DIR/f"sim_04_f1_plume_meas.{cfg.EXT}"),
    format=cfg.EXT,
)
